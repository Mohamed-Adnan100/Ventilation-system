...
# 864 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\pic18_chip_select.h" 3
...
# 864 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\pic18_chip_select.h" 2 3
...
uint8 Celsius[] = {0x03,0x03,0x00,0x0E,0x10,0x10,0x0E,0x00};
...
int main() {
    ...
    ret = lcd_4bit_send_string_pos(&lcd_1, 2, 1, "Temperature1: ");
    ret = lcd_4bit_send_string_pos(&lcd_1, 3, 1, "Temperature2: ");
    ret = lcd_4bit_send_custom_char(&lcd_1, 2, 17, Celsius,0);
    ret = lcd_4bit_send_custom_char(&lcd_1, 3, 17, Celsius,0);
    ...
    while(1){
        ...
        ret = lcd_4bit_send_string_pos(&lcd_1, 2, 14, lm35_res_1_txt);
        ret = lcd_4bit_send_string_pos(&lcd_1, 3, 14, lm35_res_2_txt);
